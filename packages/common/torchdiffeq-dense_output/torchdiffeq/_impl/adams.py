...
class VariableCoefficientAdamsBashforth(AdaptiveStepsizeODESolver):
    ...
    def __init__(
            self, func, y0, rtol, atol, implicit=True, first_step=None, max_order=_MAX_ORDER, safety=0.9, ifactor=10.0,
            dfactor=0.2, dense_output=False, **unused_kwargs
    ):
    ...
    def advance(self, final_t):
        ...
        while final_t > self.vcabm_state.prev_t[0]:
            ...
            if self.dense_output: state_list.append(copy.deepcopy(self.vcabm_state))
